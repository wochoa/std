            ...
            <div class="panel-group">
               <div class="panel panel-primary">
                   ...
                   <div class="panel-body">
                      <!--CUERPO-->
                      {{ Form::open(array('action' => 'Tramite\TupaController@store', 'class' => 'form-horizontal', 'method' =>'POST')) }}
                         {{csrf_field()}}
                          ...
                          <div class="form-group">
                             {{ Form::label('Descripción Abreviado: ', '', ['class'=>'col-sm-3 control-label', 'for'=>'FormGroup'])}}
                             <!--<label class="col-sm-3 control-label" for="FormGroup">Descripción Abreviado</label>-->
                             <div class="col-sm-7">
                                 {{ Form::text('descripcionAbreviado', '', ['id' =>  'FormGroup', 'class' => 'form-control', 'required' => 'required'])}}  
