...
@section('contenido')
    <div class="container">
        <div class="row">
            ...
            <!--fintapmenu-->
              {{ Form::open(array('action' => 'Directorio\ClasificacionController@store', 'class' => 'form-horizontal', 'method' =>'POST')) }}
              {{csrf_field()}}      
             <!--PANEL Registro-->
                      ...
                      <!--CUERPO-->
                         ...
                         <div class="form-group">
                            {{Form::label('Descripción', '', ['class'=>'col-sm-3 control-label', 'for'=>'depe_nombre'])}}
                             <div class="col-sm-7">
                            {{Form::text('cla_descripcion','', ['class' => 'form-control mayuscula','id' =>'cla_descripcion', 'placeholder'=>'Máximo 40 caracteres', 'required'=>'required', 'maxlength'=>'40' ])}}
                             </div>
                          </div>                           
						<div class="form-group">
