...
<div class="container-fluid">
    ...
    <table class="table modif" style="padding: 15px; border: black 1px solid !important;">
        <thead style="display: table-header-group">
            <tr class="sin-borde">
                <th colspan="9" class="text-center"><h1></h1></th>
            </tr>
            <tr class="sin-borde">
                <th colspan="9" class="text-center"><h4>{{$modificatoria->modif_titulo}}</h4></th>
            </tr>
            <tr class="sin-borde">
                <th class="text-left subtitle">PLIEGO</th>
                <th colspan="8" class="text-left subtitle">: 448 GOBIERNO REGIONAL HUANUCO</th>
            </tr>
            <tr class="sin-borde">
                <th class="text-left subtitle">FTE. DE FTO.</th>
                <th colspan="8" class="text-left subtitle">: {{$fuenteFinanciamiento}} - {{$tipo}}</th>
            </tr>
            <tr class="info">
        ...
        @foreach($modificaciones as $proyecto)
            <tr>
                ...
                <td class="text-right">{{Money::toMoney($proyecto['modif']->acumulado,'')}}</td>
