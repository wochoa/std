...
<!--FORMATO F2: PROGRAMACIÓN OPERATIVA DE LA ACTIVIDAD/PROYECTO-->
                    ...
                    @foreach($inversiones AS $inversion)
                        @if($insumorows!=0)
                            ...
                            <tr class="text-right">
                                ...
                                @endphp
                                <td class="text-center">{{$clasif[0]}}.{{$clasif[1]}}</td>
                                <td class="text-center">{{$clasif[2]}}</td>
                                <td class="text-center">{{$clasif[3]}}</td>
                                <td class="text-center">{{$clasif[4]}}</td>
                                <td class="text-center">{{$clasif[5]}}</td>
    ...
    <div class="container-fluid" id="example1">
        ...
        <a href="{{url('poi/exportarf3/'.$act)}}" class="btn btn-primary"><i class="glyphicon glyphicon-save-file"></i> Excel</a>             
        <a href="#" class="btn btn-default btn-success pull-right printf3" data-id="{{$act}}"><span class="glyphicon glyphicon-print"></span> Imprimir F3</a> 
    </div><br>
</div>    
