<template>
  <div class="panel-group">
    <div class="panel panel-primary">
      <div class="panel-heading">PAPELETAS PARA SOLICITAR</div>
            ...
            <div class="btn-group" role="group" aria-label="Basic example">
              <p>
                <button class="btn btn-sm btn-success" @click="exportarExcel()">
                  <span class=""></span>Exportar Excel
                </button>
              </p>
            </div>
          </div>
            ...
            <table class="table table-bordered table-hover table-condensed">
              ...
              <tbody>
                ...
                <tr v-for="(documento, index) in docPorRecibir.data" :key="index">
                  ...
                  <td class="registro">
                    <strong>Hora salida:</strong>{{ documento.hora_salida }}<br />
                    <strong>Hora retorno:</strong>{{ documento.hora_retorno }}<br />
                  </td>
                  <td class="documento">
                  ...
                  <td>
                    ...
                    <strong :class="$mq">Detalle:</strong>{{ documento.docu_detalle }}
                  </td>
                </tr>
              </tbody>
            </table>
...
export default {
  ...
  props: ['route-papeletas-usadas', 'limit'],
  ...
  methods: {
    buscarDocumentos(page = 1) {
      ...
      this.formData.esExcel = 0
      /*const params={
                formData:this.formData,
                esExcel:0,
            }*/
      axios.get(this.routePapeletasUsadas, { params: this.formData }).then(response => {
    ...
    exportarExcel() {
      ...
      axios.get(this.routePapeletasUsadas, { params: this.formData }).then(response => {
        if (response.data.length > 0) {
          ...
          var hoja = xlsx.utils.json_to_sheet(response.data)
          hoja['!cols'] = wscols
